...
# (0) ##### Simplifications ##### #
# (0.1) vector2(x,y) ... vector 3D simplification
# (0.2) vector3(x,y,z) ... vector 3D simplification
# (0.3) vector4(q0,q1,q2,q3) ... vector 4D simplification (e.g. Quaternion)
# (0.4) vector5(x0,x1,x2,x3,x4)
# (0.5) vector5(x0,x1,x2,x3,x4,x5)
